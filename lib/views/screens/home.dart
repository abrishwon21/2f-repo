                          ...
                          Container(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "From",
                                  style: bodyLarge(context, Colors.white, 22,
                                      FontWeight.w300),
                                ),
                                Text(
                                  "ADD",
                                  style: headText(context, Colors.white, 28,
                                      FontWeight.w700),
                                ),
                                Text(
                                  "Addis Ababa",
                                ...
                                Text(
                                  ...
                                  style: bodyLarge(context, Colors.white, 16,
                                      FontWeight.w200),
                                )
                              ],
                            ),
                          ...
                          Container(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Select Destination",
                                  style: bodyLarge(context, Colors.white, 18,
                                      FontWeight.w300),
                                )
                              ],
                            ),
